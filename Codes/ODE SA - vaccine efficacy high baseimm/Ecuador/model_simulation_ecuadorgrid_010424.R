...
save.image('../../../../Data/ODE_SA_Efficacy_HighBaseImm/sweep_010424_ecuadorgrid.RData')
...
saveRDS(end, '../../../../Data/ODE_SA_Efficacy_HighBaseImm/endfile_sweep010424_ecuadorgrid.RDS')
