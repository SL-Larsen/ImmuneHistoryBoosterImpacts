...
save.image('../../../../Data/ODE outputs base.wane/sweep_010224_malaysiagrid_Evax.RData')
...
saveRDS(end, '../../../../Data/ODE outputs base.wane/endfile_sweep010224_malaysiagrid_Evax.RDS')
