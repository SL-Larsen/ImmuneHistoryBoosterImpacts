...
save.image('../../../../Data/ODE outputs base.wane/sweep_010224_malaysiaboost_Evax.RData')
...
saveRDS(end, '../../../../Data/ODE outputs base.wane/endfile_sweep010224_malaysiaboost_Evax.RDS')
