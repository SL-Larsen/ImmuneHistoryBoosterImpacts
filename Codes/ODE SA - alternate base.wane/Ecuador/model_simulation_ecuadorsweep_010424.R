...
save.image('../../../../Data/ODE outputs base.wane/sweep_010424_ecuadorboost_Evax.RData')
...
saveRDS(end, '../../../../Data/ODE outputs base.wane/endfile_sweep010424_ecuadorboost_Evax.RDS')
