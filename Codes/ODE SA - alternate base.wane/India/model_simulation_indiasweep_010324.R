...
save.image('../../../../Data/ODE outputs base.wane/sweep_010324_indiaboost_Evax.RData')
...
saveRDS(end, '../../../../Data/ODE outputs base.wane/endfile_sweep010324_indiaboost_Evax.RDS')
