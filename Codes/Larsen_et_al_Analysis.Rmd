...
```{r message=FALSE}
fileNames <- list.files(path="../Data/ABM Main Runs/output_files_AS1", 
...
df_info_v1 <- tibble(fileNames = fileNames) %>% 
  mutate(indexID = str_remove(fileNames, "../Data/ABM Main Runs/output_files_AS1/output_1x_ID_")) %>%
...
write_csv(df_v1, "../Data/ABM Main Runs/concatenated data/df_AS1.csv")
```
...
df <- read_csv("../Data/ABM Main Runs/concatenated data/df_AS1.csv") %>% 
...
```{r message=FALSE}
fileNames <- list.files(path="../Data/ABM Supplement/Booster_Timing/output_files_AS", 
                     pattern=".csv", all.files=TRUE,full.names=TRUE)
...
df_info_v1 <- tibble(fileNames = fileNames) %>% 
  mutate(indexID = str_remove(fileNames, "../Data/ABM Supplement/Booster_Timing/output_files_AS/output_1x_ID_")) %>%
  mutate(indexID = str_remove(indexID, ".csv")) %>%
  mutate(indexID = parse_number(indexID)) %>% right_join(grid_v1) %>% filter(!is.na(fileNames))
...
write_csv(df_v1, "../Data/ABM Supplement/Booster_Timing/concatenated data/df_AS.csv")
```
...
df <- read_csv("../Data/ABM Supplement/Booster_Timing/concatenated data/df_AS.csv")
...
write_csv(dataAll, "../Data/ABM Supplement/Booster_Timing/dataAll.csv")
```
...
```{r message=FALSE}
fileNames <- list.files(path="../Data/ABM Supplement/Vax_Through_X/output_files_AS", 
                     pattern=".csv", all.files=TRUE,full.names=TRUE)
...
df_info_v1 <- tibble(fileNames = fileNames) %>% 
  mutate(indexID = str_remove(fileNames, "../Data/ABM Supplement/Vax_Through_X/output_files_AS/output_1x_ID_")) %>%
  mutate(indexID = str_remove(indexID, ".csv")) %>%
  mutate(indexID = parse_number(indexID)) %>% right_join(grid_v1) %>% filter(!is.na(fileNames))
...
write_csv(df_v1, "../Data/ABM Supplement/Vax_Through_X/concatenated data/df_AS.csv")
```
...
df <- read_csv("../Data/ABM Supplement/Vax_Through_X/concatenated data/df_AS.csv")
...
write_csv(dataAll, "../Data/ABM Supplement/Vax_Through_X/dataAll.csv")
```
...
```{r message=FALSE}
fileNames <- list.files(path="../Data/ABM Supplement/Same_Efficacy/output_files_AS", 
                     pattern=".csv", all.files=TRUE,full.names=TRUE)
...
df_info_v1 <- tibble(fileNames = fileNames) %>% 
  mutate(indexID = str_remove(fileNames, "../Data/ABM Supplement/Same_Efficacy/output_files_AS/output_1x_ID_")) %>%
  mutate(indexID = str_remove(indexID, ".csv")) %>%
  mutate(indexID = parse_number(indexID)) %>% right_join(grid_v1) %>% filter(!is.na(fileNames))
...
write_csv(df_v1, "../Data/ABM Supplement/Same_Efficacy/concatenated data/df_AS.csv")
```

##### Read files AS2

```{r message=FALSE}
fileNames <- list.files(path="../Data/ABM Supplement/Same_Efficacy/output_files_AS2", 
                     pattern=".csv", all.files=TRUE,full.names=TRUE)
...
df_info_v1 <- tibble(fileNames = fileNames) %>% 
  mutate(indexID = str_remove(fileNames, "../Data/ABM Supplement/Same_Efficacy/output_files_AS2/output_1x_ID_")) %>%
  mutate(indexID = str_remove(indexID, ".csv")) %>%
  mutate(indexID = parse_number(indexID)) %>% right_join(grid_v1) %>% filter(!is.na(fileNames))
...
write_csv(df_v1, "../Data/ABM Supplement/Same_Efficacy/concatenated data/df_AS2.csv")
```
...
df1 <- read_csv("../Data/ABM Supplement/Same_Efficacy/concatenated data/df_AS.csv")
df2 <- read_csv("../Data/ABM Supplement/Same_Efficacy/concatenated data/df_AS2.csv")
...
write_csv(dataAll, "../Data/ABM Supplement/Same_Efficacy/dataAll.csv")
```
...
```{r message=FALSE}
fileNames <- list.files(path="../Data/ABM Supplement/Same_Endpoint/output_files_AS", 
                     pattern=".csv", all.files=TRUE,full.names=TRUE)
...
df_info_v1 <- tibble(fileNames = fileNames) %>% 
  mutate(indexID = str_remove(fileNames, "../Data/ABM Supplement/Same_Endpoint/output_files_AS/output_1x_ID_")) %>%
  mutate(indexID = str_remove(indexID, ".csv")) %>%
  mutate(indexID = parse_number(indexID)) %>% right_join(grid_v1) %>% filter(!is.na(fileNames))
...
write_csv(df_v1, "../Data/ABM Supplement/Same_Endpoint/concatenated data/df_AS.csv")
```
...
df <- read_csv("../Data/ABM Supplement/Same_Endpoint/concatenated data/df_AS.csv")
...
write_csv(dataAll, "../Data/ABM Supplement/Same_Endpoint/dataAll.csv")
```
...
```{r message=FALSE}
fileNames <- list.files(path="../Data/ABM Supplement/Malaysia_Booster_Trend/output_files_AS", 
                     pattern=".csv", all.files=TRUE,full.names=TRUE)
...
df_info_v1 <- tibble(fileNames = fileNames) %>% 
  mutate(indexID = str_remove(fileNames, "../Data/ABM Supplement/Malaysia_Booster_Trend/output_files_AS/output_1x_ID_")) %>%
  mutate(indexID = str_remove(indexID, ".csv")) %>%
  mutate(indexID = parse_number(indexID)) %>% right_join(grid_v1) %>% filter(!is.na(fileNames))
...
write_csv(df_v1, "../Data/ABM Supplement/Malaysia_Booster_Trend/concatenated data/df_AS.csv")
```
...
df <- read_csv("../Data/ABM Supplement/Malaysia_Booster_Trend/concatenated data/df_AS.csv")
...
write_csv(dataAll, "../Data/ABM Supplement/Malaysia_Booster_Trend/dataAll.csv")
```
...
#### Concatenate replicates
```{r message=FALSE}
fileNames <- list.files(path="../Data/ABM Supplement/Delayed_boosting/output_files_AS1", 
                     pattern=".csv", all.files=TRUE,full.names=TRUE)
...
df_info_v1 <- tibble(fileNames = fileNames) %>% 
  mutate(indexID = str_remove(fileNames, "../Data/ABM Supplement/Delayed_boosting/output_files_AS1/output_1x_ID_")) %>%
  mutate(indexID = str_remove(indexID, ".csv")) %>%
  mutate(indexID = parse_number(indexID)) %>% right_join(grid_v1) %>% filter(!is.na(fileNames))
...
write_csv(df_v1, "../Data/ABM Supplement/Delayed_boosting/concatenated data/df_AS1.csv")
...
```{r message=FALSE}
fileNames <- list.files(path="../Data/ABM Supplement/Delayed_boosting/output_files_AS2", 
                     pattern=".csv", all.files=TRUE,full.names=TRUE)
...
df_info_v1 <- tibble(fileNames = fileNames) %>% 
  mutate(indexID = str_remove(fileNames, "../Data/ABM Supplement/Delayed_boosting/output_files_AS2/output_1x_ID_")) %>%
  mutate(indexID = str_remove(indexID, ".csv")) %>%
  mutate(indexID = parse_number(indexID)) %>% right_join(grid_v1) %>% filter(!is.na(fileNames))
...
write_csv(df_v1, "../Data/ABM Supplement/Delayed_boosting/concatenated data/df_AS2.csv")
...
```{r message=FALSE}
fileNames <- list.files(path="../Data/ABM Supplement/Delayed_boosting/output_files_AS3", 
                     pattern=".csv", all.files=TRUE,full.names=TRUE)
...
df_info_v1 <- tibble(fileNames = fileNames) %>% 
  mutate(indexID = str_remove(fileNames, "../Data/ABM Supplement/Delayed_boosting/output_files_AS3/output_1x_ID_")) %>%
  mutate(indexID = str_remove(indexID, ".csv")) %>%
  mutate(indexID = parse_number(indexID)) %>% right_join(grid_v1) %>% filter(!is.na(fileNames))
...
write_csv(df_v1, "../Data/ABM Supplement/Delayed_boosting/concatenated data/df_AS3.csv")
...
df <- rbind(read_csv("../Data/ABM Supplement/Delayed_boosting/concatenated data/df_AS1.csv"),read_csv("../Data/ABM Supplement/Delayed_boosting/concatenated data/df_AS2.csv") ) %>%
  rbind(read_csv("../Data/ABM Supplement/Delayed_boosting/concatenated data/df_AS3.csv"))

# df1 <- read_csv("../Data/ABM Supplement/Delayed_boosting/concatenated data/df_AS1.csv")
# df2 <- read_csv("../Data/ABM Supplement/Delayed_boosting/concatenated data/df_AS2.csv")
# 
# df <- rbind(df1, df2)
# rm(df1, df2)
# gc()
# 
# df3 <- read_csv("../Data/ABM Supplement/Delayed_boosting/concatenated data/df_AS3.csv")
# 
# df <- rbind(df, df3)
# rm(df3)
gc()
...
write_csv(dataAll, "../Data/ABM Supplement/Delayed_boosting/dataAll.csv")
...
#### concatenate
```{r message=FALSE}
fileNames <- list.files(path="../Data/ABM Supplement/100_Efficacy/output_files_AS", 
                     pattern=".csv", all.files=TRUE,full.names=TRUE)
...
df_info_v1 <- tibble(fileNames = fileNames) %>% 
  mutate(indexID = str_remove(fileNames, "../Data/ABM Supplement/100_Efficacy/output_files_AS/output_1x_ID_")) %>%
  mutate(indexID = str_remove(indexID, ".csv")) %>%
  mutate(indexID = parse_number(indexID)) %>% right_join(grid_v1) %>% filter(!is.na(fileNames))
...
write_csv(df_v1, "../Data/ABM Supplement/100_Efficacy/concatenated data/df_AS.csv")
...
write_csv(dataAll, "../Data/ABM Supplement/100_Efficacy/dataAll.csv")
...
#### concatenate
```{r message=FALSE}
fileNames <- list.files(path="../Data/ABM Supplement/53_Efficacy/output_files_AS", 
                     pattern=".csv", all.files=TRUE,full.names=TRUE)
...
df_info_v1 <- tibble(fileNames = fileNames) %>% 
  mutate(indexID = str_remove(fileNames, "../Data/ABM Supplement/53_Efficacy/output_files_AS/output_1x_ID_")) %>%
  mutate(indexID = str_remove(indexID, ".csv")) %>%
  mutate(indexID = parse_number(indexID)) %>% right_join(grid_v1) %>% filter(!is.na(fileNames))
...
write_csv(df_v1, "../Data/ABM Supplement/53_Efficacy/concatenated data/df_AS.csv")
...
write_csv(dataAll, "../Data/ABM Supplement/53_Efficacy/dataAll.csv")

```

### ABM Supp 10: Poor efficacy
...
# scale bump down by 50% to simulate a poor efficacy scenario
Booster_Bump_WT <- diff_file %>% filter(variant == "WT") %>% select("WT_vax_diff") %>% mutate(WT_vax_diff = 0.5*WT_vax_diff)
Booster_Bump_Delta <- diff_file %>% filter(variant == "WT") %>% select("Delta_vax_diff") %>% mutate(Delta_vax_diff = 0.5*Delta_vax_diff)
Booster_Bump_Omicron <- diff_file %>% filter(variant == "WT") %>% select("Omicron_vax_diff") %>% mutate(Omicron_vax_diff = 0.5*Omicron_vax_diff)
Booster_Bump_Vaccine <- diff_file %>% filter(variant == "WT") %>% select("Vax_diff") %>% mutate(Vax_diff = 0.5*Vax_diff)
...
write_csv(savefile , "../Data/ABM_Parameters_Data/paramScale_MonOm_POOREFF.csv")
...
serotypes_star <- read_csv("../Data/ABM_Parameters_Data/paramScale_MonOm_POOREFF.csv") %>% 
  select(history, Bivalent_penalty, Bivalent_efficacy, Bivalent_endpoint, 
         Monovalent_WTpenalty,Monovalent_Ompenalty, 
         Monovalent_WTefficacy, Monovalent_Omefficacy,
         Monovalent_WTendpoint, Monovalent_Omendpoint) %>% 
...
serotypes_Omicron <- read_csv("../Data/ABM_Parameters_Data/paramScale_MonOm_POOREFF.csv") %>% 
  select(history, Bivalent_penalty_Omicron, Bivalent_efficacy_Omicron, Bivalent_endpoint_Omicron, 
         Monovalent_WTpenalty_Omicron,Monovalent_Ompenalty_Omicron, 
         Monovalent_WTefficacy_Omicron, Monovalent_Omefficacy_Omicron,
         Monovalent_WTendpoint_Omicron, Monovalent_Omendpoint_Omicron) %>% 
...
write_csv(df_everything, "../Data/ABM_Parameters_Data/Grid_Param_PoorEff.csv")
...
#### Concatenate
```{r message=FALSE}
fileNames <- list.files(path="../Data/ABM Supplement/Poor_Booster_Eff/output_files_AS", 
                     pattern=".csv", all.files=TRUE,full.names=TRUE)

grid_v1 <- read_csv("../Data/ABM_Parameters_Data/Grid_Param_PoorEff.csv") %>%
  mutate(indexID = row_number())

df_info_v1 <- tibble(fileNames = fileNames) %>% 
  mutate(indexID = str_remove(fileNames, "../Data/ABM Supplement/Poor_Booster_Eff/output_files_AS/output_1x_ID_")) %>%
  mutate(indexID = str_remove(indexID, ".csv")) %>%
  mutate(indexID = parse_number(indexID)) %>%
  right_join(grid_v1) %>% filter(!is.na(fileNames))
...
write_csv(df_v1, "../Data/ABM Supplement/Poor_Booster_Eff/concatenated data/df_AS.csv")
...
write_csv(dataAll, "../Data/ABM Supplement/Poor_Booster_Eff/concatenated data/dataAll.csv")
```

### ABM Supp 11: homogeneous severity
...
write_csv(df_everything, "../Data/ABM_Parameters_Data/Grid_Param_even_severity.csv")
...
#### Concatenate
```{r message=FALSE}
fileNames <- list.files(path="../Data/ABM Supplement/TCell_Severity/output_files_AS", 
                     pattern=".csv", all.files=TRUE,full.names=TRUE)

grid_v1 <- read_csv("../Data/ABM_Parameters_Data/Grid_Param_even_severity.csv") %>%
  mutate(indexID = row_number())

df_info_v1 <- tibble(fileNames = fileNames) %>% 
  mutate(indexID = str_remove(fileNames, "../Data/ABM Supplement/TCell_Severity/output_files_AS/output_1x_ID_")) %>%
  mutate(indexID = parse_number(indexID)) %>% right_join(grid_v1) %>% filter(!is.na(fileNames))
...
write_csv(df_v1, "../Data/ABM Supplement/TCell_Severity/concatenated data/df_AS.csv")
...
write_csv(dataAll, "../Data/ABM Supplement/TCell_Severity/concatenated data/dataAll.csv")
```
...
dataHistories899 <- df_v1 %>%
  mutate(time = as.integer(time)) %>%
  filter(booster == "no booster", vaccine_star == "no", SAR == 1.3*0.427, time == 899) %>%
  select(Name, N, count_Naive:count_Vaccine_boost, replicate, time) %>%
  # rbind(datahist2) %>%
  # rbind(datahist3) %>%
  # rbind(datahist4) %>%
...
write_csv(dataHistories899, "../Data/ABM Supplement/TCell_Severity/concatenated data/dataHistories899.csv")
...
end_malaysia_sweep<-readRDS('../Data/ODE - even severity/endfile_sweep010224_malaysiagrid_Evax.RDS')
end_malaysia_sweep$popsize<-28552712
end_malaysia_sweep$deaths_100k<-(end_malaysia_sweep$DeathsAll/end_malaysia_sweep$popsize)*100000
end_noboost_malaysia<-subset(end_malaysia_sweep, end_malaysia_sweep$boost.adult==0)
end_boost_malaysia<-subset(end_malaysia_sweep, end_malaysia_sweep$boost.adult>0)
...
write_csv(df_AvertedODE, "../Data/ODE Supplement/Malaysia_grid_da_EVEN_SEVERITY.csv")
```
...
end_ecuador_sweep<-readRDS('../Data/ODE - even severity/endfile_sweep010424_ecuadorgrid.RDS')
end_ecuador_sweep$popsize<-15735139
end_ecuador_sweep$deaths_100k<-(end_ecuador_sweep$DeathsAll/end_ecuador_sweep$popsize)*100000
end_noboost_ecuador<-subset(end_ecuador_sweep, end_ecuador_sweep$boost.adult==0)
end_boost_ecuador<-subset(end_ecuador_sweep, end_ecuador_sweep$boost.adult>0)
...
write_csv(df_AvertedODE, "../Data/ODE Supplement/Ecuador_grid_da_EVEN_SEVERITY.csv")
```
...
end_india_sweep<-readRDS('../Data/ODE - even severity/endfile_sweep010324_indiagrid_Evax.RDS')
end_india_sweep$popsize<-1155561222
end_india_sweep$deaths_100k<-(end_india_sweep$DeathsAll/end_india_sweep$popsize)*100000
end_noboost_india<-subset(end_india_sweep, end_india_sweep$boost.adult==0)
end_boost_india<-subset(end_india_sweep, end_india_sweep$boost.adult>0)
...
write_csv(df_AvertedODE, "../Data/ODE Supplement/India_grid_da_EVEN_SEVERITY.csv")
```
...
end_malaysia_sweep<-readRDS('../Data/ODE - even severity/endfile_sweep010224_malaysiaboost_Evax.RDS')
end_malaysia_sweep$popsize<-28552712
end_malaysia_sweep$deaths_100k<-(end_malaysia_sweep$DeathsAll/end_malaysia_sweep$popsize)*100000
end_noboost_malaysia<-subset(end_malaysia_sweep, end_malaysia_sweep$boost.adult==0)
end_boost_malaysia<-subset(end_malaysia_sweep, end_malaysia_sweep$boost.adult>0)
...
write_csv(df_AvertedODE, "../Data/ODE Supplement/Malaysia_run_da_EVEN_SEVERITY.csv")
```
...
end_ecuador_sweep<-readRDS('../Data/ODE - even severity/endfile_sweep010424_ecuadorboost_Evax.RDS') %>% 
  rename(sd = sd0)
end_ecuador_sweep$popsize<-15735139
end_ecuador_sweep$deaths_100k<-(end_ecuador_sweep$DeathsAll/end_ecuador_sweep$popsize)*100000
end_noboost_ecuador<-subset(end_ecuador_sweep, end_ecuador_sweep$boost.adult==0)
...
write_csv(df_AvertedODE, "../Data/ODE Supplement/Ecuador_run_da_EVEN_SEVERITY.csv")
```
...
end_india_sweep<-readRDS('../Data/ODE - even severity/endfile_sweep010324_indiaboost_Evax.RDS')
end_india_sweep$popsize<-1155561222
end_india_sweep$deaths_100k<-(end_india_sweep$DeathsAll/end_india_sweep$popsize)*100000
end_noboost_india<-subset(end_india_sweep, end_india_sweep$boost.adult==0)
end_boost_india<-subset(end_india_sweep, end_india_sweep$boost.adult>0)
...
write_csv(df_AvertedODE, "../Data/ODE Supplement/India_run_da_EVEN_SEVERITY.csv")
```
...
load('../Data/ODE - even severity/sweep_010224_malaysiaboost_Evax.RData')
model_out_dat$sweepnum<-rep(seq(from=1, to=27), each=196)
model_out_dat$Iall<-model_out_dat$Ich+model_out_dat$Ich2+model_out_dat$IVch+model_out_dat$IVch2+model_out_dat$IBch+model_out_dat$IBch2+
  model_out_dat$Iah+model_out_dat$Iah2+model_out_dat$IVah+model_out_dat$IVah2+model_out_dat$IBah+model_out_dat$IBah2+
  model_out_dat$Ieh+model_out_dat$Ieh2+model_out_dat$IVeh+model_out_dat$IVeh2+model_out_dat$IBeh+model_out_dat$IBeh2+
...
write_csv(model_out_dat, "../Data/ODE Supplement/Malaysia_ts_EVEN_SEVERITY.csv")
```
...
load('../Data/ODE - even severity/sweep_010424_ecuadorboost_Evax.RData')
model_out_dat$sweepnum<-rep(seq(from=1, to=27), each=196)
model_out_dat$Iall<-model_out_dat$Ich+model_out_dat$Ich2+model_out_dat$IVch+model_out_dat$IVch2+model_out_dat$IBch+model_out_dat$IBch2+
  model_out_dat$Iah+model_out_dat$Iah2+model_out_dat$IVah+model_out_dat$IVah2+model_out_dat$IBah+model_out_dat$IBah2+
  model_out_dat$Ieh+model_out_dat$Ieh2+model_out_dat$IVeh+model_out_dat$IVeh2+model_out_dat$IBeh+model_out_dat$IBeh2+
...
write_csv(model_out_dat, "../Data/ODE Supplement/Ecuador_ts_EVEN_SEVERITY.csv")
```
...
load('../Data/ODE - even severity/sweep_010324_indiaboost_Evax.RData')
model_out_dat$sweepnum<-rep(seq(from=1, to=27), each=196)
model_out_dat$Iall<-model_out_dat$Ich+model_out_dat$Ich2+model_out_dat$IVch+model_out_dat$IVch2+model_out_dat$IBch+model_out_dat$IBch2+
  model_out_dat$Iah+model_out_dat$Iah2+model_out_dat$IVah+model_out_dat$IVah2+model_out_dat$IBah+model_out_dat$IBah2+
  model_out_dat$Ieh+model_out_dat$Ieh2+model_out_dat$IVeh+model_out_dat$IVeh2+model_out_dat$IBeh+model_out_dat$IBeh2+
...
write_csv(model_out_dat, "../Data/ODE Supplement/India_ts_EVEN_SEVERITY.csv")
