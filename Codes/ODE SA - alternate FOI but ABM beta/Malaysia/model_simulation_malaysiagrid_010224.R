...
save.image('../../../../Data/ODE outputs SA - ABM beta/sweep_010224_malaysiagrid_Evax.RData')
...
saveRDS(end, '../../../../Data/ODE outputs SA - ABM beta/endfile_sweep010224_malaysiagrid_Evax.RDS')
