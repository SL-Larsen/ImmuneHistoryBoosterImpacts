...
source("model_setting_malaysiasweep_010224.R")
...
save.image('../../../../Data/ODE outputs SA - ABM beta/sweep_010224_malaysiaboost_Evax.RData')
...
saveRDS(end, '../../../../Data/ODE outputs SA - ABM beta/endfile_sweep010224_malaysiaboost_Evax.RDS')
