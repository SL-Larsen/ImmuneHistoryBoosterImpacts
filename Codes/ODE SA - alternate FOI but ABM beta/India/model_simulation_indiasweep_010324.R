...
source("model_setting_indiasweep_010324.R")
...
model_sims <- function(i){
  ...
  #leading to 
  dist<-c(0.355*lses, 0.355*hses, 0.587*lses, 0.587*hses, 0.058*lses, 0.058*hses)
  
  start.Ns<-dist*(1155561222)
  distI<-c(0.354*lses, 0.354*hses, 0.5865*lses, 0.5865*hses, 0.0595*lses, 0.0595*hses) #
  distH<-c(0.022*lses, 0.022*hses, 0.751*lses, 0.751*hses, 0.227*lses, 0.227*hses) #Age distribution for hospitalizations, 
  ...
  report<-(0.053) #Reporting rate, lower bound on reporting with upper bound on CI
  ...
  pvax<-c(0.93, 0.78, 0.93, 0.78, 0.93, 0.78)
  ...
  start.Is<-distI*(19153)*(1/report) #To get current Is, did sum(I.new, t=0:7) with rounding 
...
save.image('../../../../Data/ODE outputs SA - ABM beta/sweep_010324_indiaboost_Evax.RData')
...
saveRDS(end, '../../../../Data/ODE outputs SA - ABM beta/endfile_sweep010324_indiaboost_Evax.RDS')
