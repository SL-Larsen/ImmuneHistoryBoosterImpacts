...
source("model_setting_indiagrid_010324.R")
...
save.image('../../../../Data/ODE outputs SA - ABM beta/sweep_010324_indiagrid_Evax.RData')
...
saveRDS(end, '../../../../Data/ODE outputs SA - ABM beta/endfile_sweep010324_indiagrid_Evax.RDS')
