...
source("model_setting_ecuadorgrid_010424.R")
tmax<-195
...
model_sims <- function(i){
  ...
  start.Is<-distI*(1798)*(1/report) #To get current Is, did sum(I.new, t=0:7) with rounding 
...
save.image('../../../../Data/ODE outputs SA - ABM beta/sweep_010424_ecuadorgrid.RData')
...
saveRDS(end, '../../../../Data/ODE outputs SA - ABM beta/endfile_sweep010424_ecuadorgrid.RDS')
